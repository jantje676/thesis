...
_app_flags.DEFINE_integer("input_sequence_length", default=64, help='')
_app_flags.DEFINE_integer("vocab_size", default=30522, help='')
_app_flags.DEFINE_integer("image_feature_size", default=2048, help='')
...
class ImageBertPretrain(base_model):
    ...
    def build_logits(self, features, mode=None):
        ...
        print(">>>>>>>>>>",_APP_FLAGS.input_sequence_length)
