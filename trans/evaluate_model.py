...
# python evaluate_model.py --model_path "runs/" --run trans1 --vocab_path "../vocab/" --version laenen_1k --data_path "../data/"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Evaluate trained trans-SCAN model')
    ...
    parser.add_argument('--version', default="laenen_1k", type=str, help='which version of features and vocab to use')
