...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='Fashion200k', type=str, help='dataset name')
    ...
    parser.add_argument('--output_dir', default='checkpoints_dis', type=str, help='output directory')
    ...
    parser.add_argument('--ckpt_dir', default='checkpoints_dis', type=str, help='checkpoint directory')
