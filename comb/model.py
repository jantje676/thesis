...
def EncoderImage(sigmoid, data_name, img_dim, embed_size, n_attention, n_detectors, pretrained_alex, rectangle, precomp_enc_type='basic',
    ...
    if precomp_enc_type == "trans":
        ...
        img_enc = LayerAttention2(sigmoid, img_dim, embed_size, n_attention, no_imgnorm, net)
...
class SCAN(object):
    ...
    def __init__(self, opt):
        ...
        self.img_enc = EncoderImage(opt.sigmoid, opt.data_name, opt.img_dim, opt.embed_size, opt.n_attention,
