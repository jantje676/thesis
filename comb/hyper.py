...
def random_params(opt, randomHyper):
    ...
    opt.word_dim = 300 # 100, 200, 300, 400
    opt.embed_size = 1024 # 512, 1024, 2048
    opt.num_layers = 1 # 1, 2, 3
    opt.learning_rate= randomHyper.choice ([0.002, 0.0002]) # 0.00002, 0.000002
    opt.lr_update = randomHyper.choice ([25, 35]) # 5, 10
    ...
    opt.lambda_softmax = float(randomHyper.randint(opt.lambda_lse,15)) # 1-15
