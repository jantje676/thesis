...
if __name__ == "__main__":
    ...
    parser.add_argument('--create_batch', default=4, type=int, help='actual size of "batch"')
    ...
    parser.add_argument('--output_dir', default="runs_simCLR_adap/", type=str, help='directory to output runs')
